...
public class CustomerCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancle=(Button)findViewById(R.id.btnDecline);
        ...
        mediaPlayer =MediaPlayer.create(this,R.raw.amb);
    ...
    private void cancleBooking(String customerId) {
        ...
        Notification notification=new Notification("Cancle","Driver has cancelled your request");
